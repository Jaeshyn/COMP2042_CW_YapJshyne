...
import p4_group_8_repo.gameOperationKey;
...
public static void ShowCharacter(String args[]){ 
		...
		Stage CharacterScreen = new Stage();
		  ...
		  Image frogIcon = new Image("file:src/p4_group_8_repo/froggerUp.png");
		...
		//Timer as a time recorder
		  Image TimerIcon = new Image("file:src/p4_group_8_repo/5.png");
		...
		//car as a moving obstacle
		  Image carIcon = new Image("file:src/p4_group_8_repo/car1Left.png");
		...
		//green turtle as a moving obstacle
		  Image greenTurtleIcon = new Image("file:src/p4_group_8_repo/TurtleAnimation3Wet.png");
		...
		//miniTruck as a moving obstacle
		  Image minitruckIcon = new Image("file:src/p4_group_8_repo/truck1Right.png");
		 ...
		 //truck as a moving obstacle
		  Image truckIcon = new Image("file:src/p4_group_8_repo/truck2Right.png");
		  ...
		  Image redTurtleIcon = new Image("file:src/p4_group_8_repo/TurtleAnimation1.png");
		  ...
		  Image miniLogIcon = new Image("file:src/p4_group_8_repo/log2.png");
		...
		//Log as a moving obstacle
		  Image LogIcon = new Image("file:src/p4_group_8_repo/logs.png");
