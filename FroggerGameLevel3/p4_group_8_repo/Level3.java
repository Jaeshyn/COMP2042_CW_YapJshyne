...
public class Level3 {
	...
	public static void start(String args[]){
		...
		background.add(new Log("file:src/p4_group_8_repo/logs.png", 300, 0, 276, -4));
		background.add(new Log("file:src/p4_group_8_repo/logs.png", 300, 400, 276, -4));
		
		//add and Wet turtle to the game
		background.add(new WetTurtle(600, 217, -3, 130, 130));
		background.add(new WetTurtle(400, 217, -3, 130, 130));
		background.add(new WetTurtle(200, 217, -3, 130, 130));
		...
		background.add(new Obstacle("file:src/p4_group_8_repo/car1Left.png", 100, 587, -4, 50, 50));
		background.add(new Obstacle("file:src/p4_group_8_repo/car1Left.png", 250, 587, -4, 50, 50));
		background.add(new Obstacle("file:src/p4_group_8_repo/car1Left.png", 400, 587, -4, 50, 50));
		background.add(new Obstacle("file:src/p4_group_8_repo/car1Left.png", 550, 587, -4, 50, 50));
